...
class OffboardControl : public rclcpp::Node {
	public:
		OffboardControl() : Node("test") { 
			...
			rescue_return_sub_ = this->create_subscription<geometry_msgs::msg::Point>("/landing/rel_point_cam", 10, //landing node named the msg as so
																				[this](const geometry_msgs::msg::Point::SharedPtr msg) {
																					target_from_sub_x_ = msg->x;
																					target_from_sub_y_ = msg->y;
																					target_from_sub_z_ = msg->z;});
	...
	private:
		...
		rclcpp::Subscription<geometry_msgs::msg::Point>::SharedPtr rescue_return_sub_;
		...
		void points_from_rr_sub(const geometry_msgs::msg::Point::SharedPtr msg);
		float target_from_sub_x_;
		float target_from_sub_y_;
		float target_from_sub_z_;
